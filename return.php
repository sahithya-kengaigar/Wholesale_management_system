...
<body>
    ...
    <div class='sidebar'>
		...
		<button onclick="location.href='return.php'">Return Product</button>
    ...
    <div class='container'>
        ...
        <fieldset>
            <legend><b>Return Your Product</b></legend>
                <?php 
		...
		?>
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method='get'>
                    <input class='formInputItem' type=text name="catID" placeholder="Enter Category ID" required><input
                        class='goBtn' type=submit name='submit' value='Go'>
                </form><br><br>
        </fieldset>
        <?php 
			if(isset($_GET['submit'])){
				...
				echo "</table>
		    <form action='returncart.php' method='get'>
		    	<input class='formInputItem' type=text name='productID' placeholder='Enter Product ID' required>
                <input class='formInputItem' type=text name='quantity' placeholder='Enter Quantity' required></br>
				<label for='textarea'>Reason: </label><textarea id='textarea' name='address' required></textarea><br>
                <input class='goBtn' type=submit name='addToCart' value='Return'>
		    </form>
		</fieldset><br>";
